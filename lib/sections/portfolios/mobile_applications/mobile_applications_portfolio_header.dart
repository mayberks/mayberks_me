...
/// the mobile application portfolio header section.
class MobileApplicationsPortfolioHeader extends StatelessWidget {
  const MobileApplicationsPortfolioHeader({Key? key}) : super(key: key);
