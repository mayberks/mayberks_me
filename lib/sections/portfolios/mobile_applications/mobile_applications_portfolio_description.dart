...
/// the mobile application portfolio description section.
class MobileApplicationsPortfolioDescription extends StatelessWidget {
  const MobileApplicationsPortfolioDescription({Key? key}) : super(key: key);
